...
public class PrincipaleDocente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PrincipaleDocente frame = new PrincipaleDocente();
	...
	public PrincipaleDocente() {
		...
		JButton btnNewButton_4 = new JButton("Monitoraggio");
		panel.add(btnNewButton_4);
		
		JButton btnNewButton_5 = new JButton("e-mail");
